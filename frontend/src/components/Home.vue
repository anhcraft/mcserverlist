                ...
                <template slot-scope="props">
                                ...
                                <b-taglist class="mb-5 m-tb-5 m-mb-5" attached>
                                    ...
                                    <b-tag>
                                        <span v-if="props.row.ping.result.version !== undefined">
                                            {{ ifDefined(props.row.ping.result.version.name, "~") }}
                                        </span>
                                    </b-tag>
                                </b-taglist>
                            </div>
                    ...
                    <b-table-column field="ping.result.players.online" label="Người chơi" sortable>
                        <span v-if="props.row.ping.success">
                            <b-icon icon="account-group" size="is-small"></b-icon> {{ props.row.ping.result.players.online }}/{{ props.row.ping.result.players.max }}
                        </span>
                    </b-table-column>
                </template>
