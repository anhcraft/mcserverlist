            ...
            <div class="hero-body">
                <div class="container">
                    <header class="is-size-3 has-text-weight-medium has-text-grey">
                        <b-icon icon="account is-large"></b-icon> Đăng xuất
                    </header>
                    <section class="mt-15">
                        <p>Bạn có chắc chắn muốn đăng xuất không?</p>

                        <div class="buttons mt-35">
                            <b-button class="mt-10 m-tt-10 m-mt-10" type="is-success" outlined icon-left="check" @click="confirmLogout">Có</b-button>
                            <b-button class="mt-10 m-tt-10 m-mt-10" type="is-danger" outlined icon-left="close" @click="cancelLogout">Không</b-button>
                        </div>
                    </section>
                </div>
            </div>
