            ...
            <div class="hero-body">
                <div class="container">
                    <header class="is-size-3 has-text-weight-medium has-text-grey">
                        <b-icon icon="account is-large"></b-icon> Đăng nhập
                    </header>
                    <section class="mt-15">
                        <b-field label="Tài khoản/Email trên minecraftvn.net" :type="{ 'is-danger': hasError }">
                            <b-input v-model="login" required></b-input>
                        </b-field>

                        <b-field label="Mật khẩu" :type="{ 'is-danger': hasError }">
                            <b-input type="password" v-model="password" password-reveal required></b-input>
                        </b-field>

                        <b-button class="mt-10 m-tt-10 m-mt-10" type="is-info" outlined icon-left="check" @click="doLogin">Xác nhận</b-button>
                    </section>
                </div>
            </div>
        </div>
